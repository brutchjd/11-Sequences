...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [22, 824, 12, 10, -10, 40, 3, 23]
    threshold = 22
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [55, 84, 22, 30, 130, 240, 33, 1]
    threshold = 22
    expected = 6
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 7
    actual = count_positive_sines([1, 2, 2, 2, 3, 6, 6, 7, 8])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 48
    actual = sum_first_n([12, 12, 12, 12, 12, 12, 1], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 4
    actual = sum_first_n([1, 1, 0, 1, 1, 1, 1], 5)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
